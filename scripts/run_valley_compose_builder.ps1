# PROPOSITO: Automatizar run valley compose builder no workspace Valley.
# CONTEXTO: Este script apoia operacao local, release, runtime ou manutencao ligada ao caminho scripts/run_valley_compose_builder.ps1.
