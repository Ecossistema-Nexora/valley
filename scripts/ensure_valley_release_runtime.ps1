# PROPOSITO: Automatizar ensure valley release runtime no workspace Valley.
# CONTEXTO: Este script apoia operacao local, release, runtime ou manutencao ligada ao caminho scripts/ensure_valley_release_runtime.ps1.
