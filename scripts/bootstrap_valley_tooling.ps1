# PROPOSITO: Automatizar bootstrap valley tooling no workspace Valley.
# CONTEXTO: Este script apoia operacao local, release, runtime ou manutencao ligada ao caminho scripts/bootstrap_valley_tooling.ps1.
