# PROPOSITO: Automatizar ensure valley product public no workspace Valley.
# CONTEXTO: Este script apoia operacao local, release, runtime ou manutencao ligada ao caminho scripts/ensure_valley_product_public.ps1.
