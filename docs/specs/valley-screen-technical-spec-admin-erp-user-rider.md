<!--
PROPOSITO: Especificacao tecnica fechada por tela para Admin, Lojista, Usuario APK Android e Entregador.
CONTEXTO: Documento importado do pacote Valley 000 para complementar o handoff Stitch/Figma/Flutter e a homologacao por persona.
REGRAS: Usar como contrato de produto, UI, API, dados, QA e compliance; preservar nomenclatura Valley/Helena/V-Coin.
-->
