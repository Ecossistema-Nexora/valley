...
- OK - `manifest.postgres_present`: 36 migrations PostgreSQL declaradas.
- OK - `manifest.mongodb_present`: 5 scripts MongoDB declarados.
...
- OK - `postgres.020.exists`: database/postgres/020_v47_fix_tech_owner_coherence_trigger.sql
- OK - `postgres.020.order`: dependencias OK
- OK - `postgres.021.exists`: database/postgres/021_v47_fix_city_ops_trigger_ambiguity.sql
- OK - `postgres.021.order`: dependencias OK
- OK - `postgres.022.exists`: database/postgres/022_v47_city_mobility_security_business_ddl.sql
- OK - `postgres.022.order`: dependencias OK
- OK - `postgres.023.exists`: database/postgres/023_v47_commerce_fintech_assets_business_ddl.sql
- OK - `postgres.023.order`: dependencias OK
- OK - `postgres.024.exists`: database/postgres/024_v47_ai_memory_operations_business_ddl.sql
- OK - `postgres.024.order`: dependencias OK
- OK - `postgres.025.exists`: database/postgres/025_v47_media_social_growth_business_ddl.sql
- OK - `postgres.025.order`: dependencias OK
- OK - `postgres.026.exists`: database/postgres/026_v47_frontier_iot_energy_business_ddl.sql
- OK - `postgres.026.order`: dependencias OK
- OK - `postgres.027.exists`: database/postgres/027_v47_helena_identity_pricing_guardrails.sql
- OK - `postgres.027.order`: dependencias OK
- OK - `postgres.028.exists`: database/postgres/028_v47_module_catalog_42_47_seed.sql
- OK - `postgres.028.order`: dependencias OK
- OK - `postgres.029.exists`: database/postgres/029_v47_module_catalog_registry_aliases.sql
- OK - `postgres.029.order`: dependencias OK
- OK - `postgres.030.exists`: database/postgres/030_v47_fix_gold_campaign_reward_type_ambiguity.sql
- OK - `postgres.030.order`: dependencias OK
- OK - `postgres.031.exists`: database/postgres/031_v47_fix_pepita_account_status_ambiguity.sql
- OK - `postgres.031.order`: dependencias OK
- OK - `postgres.032.exists`: database/postgres/032_v47_mobility_production_schema.sql
- OK - `postgres.032.order`: dependencias OK
- OK - `postgres.033.exists`: database/postgres/033_v47_stock_dropshipping_production_blueprint.sql
- OK - `postgres.033.order`: dependencias OK
- OK - `postgres.034.exists`: database/postgres/034_v47_foundation_futureproof_enrichment.sql
- OK - `postgres.034.order`: dependencias OK
- OK - `postgres.035.exists`: database/postgres/035_v47_phase1_commerce_identity_engagement.sql
- OK - `postgres.035.order`: dependencias OK
- OK - `postgres.036.exists`: database/postgres/036_v47_dropshipping_curation_engine.sql
- OK - `postgres.036.order`: dependencias OK
...
- OK - `mongodb.mongo-005.exists`: database/mongodb/005_v47_brain_futureproof_enrichment.mongo.js
- OK - `mongodb.mongo-005.order`: dependencias OK
...
- OK - `seed.database/domain-delivery/priority-domains/media_social_growth/operational_seed.sql.exists`: database/domain-delivery/priority-domains/media_social_growth/operational_seed.sql
- OK - `seed.database/domain-delivery/priority-domains/frontier_iot_energy/operational_seed.sql.exists`: database/domain-delivery/priority-domains/frontier_iot_energy/operational_seed.sql
...
- OK - `database/postgres/020_v47_fix_tech_owner_coherence_trigger.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/020_v47_fix_tech_owner_coherence_trigger.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/020_v47_fix_tech_owner_coherence_trigger.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/020_v47_fix_tech_owner_coherence_trigger.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/020_v47_fix_tech_owner_coherence_trigger.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/021_v47_fix_city_ops_trigger_ambiguity.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/021_v47_fix_city_ops_trigger_ambiguity.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/021_v47_fix_city_ops_trigger_ambiguity.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/021_v47_fix_city_ops_trigger_ambiguity.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/021_v47_fix_city_ops_trigger_ambiguity.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/022_v47_city_mobility_security_business_ddl.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/022_v47_city_mobility_security_business_ddl.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/022_v47_city_mobility_security_business_ddl.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/022_v47_city_mobility_security_business_ddl.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/022_v47_city_mobility_security_business_ddl.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/023_v47_commerce_fintech_assets_business_ddl.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/023_v47_commerce_fintech_assets_business_ddl.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/023_v47_commerce_fintech_assets_business_ddl.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/023_v47_commerce_fintech_assets_business_ddl.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/023_v47_commerce_fintech_assets_business_ddl.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/024_v47_ai_memory_operations_business_ddl.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/024_v47_ai_memory_operations_business_ddl.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/024_v47_ai_memory_operations_business_ddl.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/024_v47_ai_memory_operations_business_ddl.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/024_v47_ai_memory_operations_business_ddl.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/025_v47_media_social_growth_business_ddl.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/025_v47_media_social_growth_business_ddl.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/025_v47_media_social_growth_business_ddl.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/025_v47_media_social_growth_business_ddl.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/025_v47_media_social_growth_business_ddl.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/026_v47_frontier_iot_energy_business_ddl.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/026_v47_frontier_iot_energy_business_ddl.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/026_v47_frontier_iot_energy_business_ddl.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/026_v47_frontier_iot_energy_business_ddl.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/026_v47_frontier_iot_energy_business_ddl.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/027_v47_helena_identity_pricing_guardrails.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/027_v47_helena_identity_pricing_guardrails.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/027_v47_helena_identity_pricing_guardrails.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/027_v47_helena_identity_pricing_guardrails.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/027_v47_helena_identity_pricing_guardrails.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/028_v47_module_catalog_42_47_seed.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/028_v47_module_catalog_42_47_seed.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/028_v47_module_catalog_42_47_seed.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/028_v47_module_catalog_42_47_seed.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/028_v47_module_catalog_42_47_seed.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/029_v47_module_catalog_registry_aliases.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/029_v47_module_catalog_registry_aliases.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/029_v47_module_catalog_registry_aliases.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/029_v47_module_catalog_registry_aliases.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/029_v47_module_catalog_registry_aliases.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/030_v47_fix_gold_campaign_reward_type_ambiguity.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/030_v47_fix_gold_campaign_reward_type_ambiguity.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/030_v47_fix_gold_campaign_reward_type_ambiguity.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/030_v47_fix_gold_campaign_reward_type_ambiguity.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/030_v47_fix_gold_campaign_reward_type_ambiguity.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/031_v47_fix_pepita_account_status_ambiguity.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/031_v47_fix_pepita_account_status_ambiguity.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/031_v47_fix_pepita_account_status_ambiguity.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/031_v47_fix_pepita_account_status_ambiguity.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/031_v47_fix_pepita_account_status_ambiguity.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/032_v47_mobility_production_schema.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/032_v47_mobility_production_schema.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/032_v47_mobility_production_schema.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/032_v47_mobility_production_schema.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/032_v47_mobility_production_schema.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/033_v47_stock_dropshipping_production_blueprint.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/033_v47_stock_dropshipping_production_blueprint.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/033_v47_stock_dropshipping_production_blueprint.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/033_v47_stock_dropshipping_production_blueprint.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/033_v47_stock_dropshipping_production_blueprint.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/034_v47_foundation_futureproof_enrichment.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/034_v47_foundation_futureproof_enrichment.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/034_v47_foundation_futureproof_enrichment.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/034_v47_foundation_futureproof_enrichment.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/034_v47_foundation_futureproof_enrichment.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/035_v47_phase1_commerce_identity_engagement.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/035_v47_phase1_commerce_identity_engagement.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/035_v47_phase1_commerce_identity_engagement.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/035_v47_phase1_commerce_identity_engagement.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/035_v47_phase1_commerce_identity_engagement.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/postgres/036_v47_dropshipping_curation_engine.sql.begin`: Migration contem BEGIN.
- OK - `database/postgres/036_v47_dropshipping_curation_engine.sql.commit`: Migration contem COMMIT.
- OK - `database/postgres/036_v47_dropshipping_curation_engine.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/postgres/036_v47_dropshipping_curation_engine.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/postgres/036_v47_dropshipping_curation_engine.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
...
- OK - `database/mongodb/005_v47_brain_futureproof_enrichment.mongo.js.node_check`: node --check OK
...
- OK - `database/domain-delivery/priority-domains/platform_developer/operational_seed.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/domain-delivery/priority-domains/platform_developer/operational_seed.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/domain-delivery/priority-domains/logistics_erp_operations/operational_seed.sql.begin`: Migration contem BEGIN.
- OK - `database/domain-delivery/priority-domains/logistics_erp_operations/operational_seed.sql.commit`: Migration contem COMMIT.
- OK - `database/domain-delivery/priority-domains/logistics_erp_operations/operational_seed.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/domain-delivery/priority-domains/logistics_erp_operations/operational_seed.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/domain-delivery/priority-domains/logistics_erp_operations/operational_seed.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/domain-delivery/priority-domains/ai_memory_operations/operational_seed.sql.begin`: Migration contem BEGIN.
- OK - `database/domain-delivery/priority-domains/ai_memory_operations/operational_seed.sql.commit`: Migration contem COMMIT.
- OK - `database/domain-delivery/priority-domains/ai_memory_operations/operational_seed.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/domain-delivery/priority-domains/ai_memory_operations/operational_seed.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/domain-delivery/priority-domains/ai_memory_operations/operational_seed.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/domain-delivery/priority-domains/media_social_growth/operational_seed.sql.begin`: Migration contem BEGIN.
- OK - `database/domain-delivery/priority-domains/media_social_growth/operational_seed.sql.commit`: Migration contem COMMIT.
- OK - `database/domain-delivery/priority-domains/media_social_growth/operational_seed.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/domain-delivery/priority-domains/media_social_growth/operational_seed.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/domain-delivery/priority-domains/media_social_growth/operational_seed.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/domain-delivery/priority-domains/frontier_iot_energy/operational_seed.sql.begin`: Migration contem BEGIN.
- OK - `database/domain-delivery/priority-domains/frontier_iot_energy/operational_seed.sql.commit`: Migration contem COMMIT.
- OK - `database/domain-delivery/priority-domains/frontier_iot_energy/operational_seed.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/domain-delivery/priority-domains/frontier_iot_energy/operational_seed.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/domain-delivery/priority-domains/frontier_iot_energy/operational_seed.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/domain-delivery/priority-domains/city_mobility_security/operational_seed.sql.begin`: Migration contem BEGIN.
- OK - `database/domain-delivery/priority-domains/city_mobility_security/operational_seed.sql.commit`: Migration contem COMMIT.
- OK - `database/domain-delivery/priority-domains/city_mobility_security/operational_seed.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
- OK - `database/domain-delivery/priority-domains/city_mobility_security/operational_seed.sql.no_raw_delete`: Sem DELETE FROM em migration de schema.
- OK - `database/domain-delivery/priority-domains/city_mobility_security/operational_seed.sql.has_comments`: Arquivo contem comentarios ou COMMENT ON.
- OK - `database/domain-delivery/priority-domains/commerce_fintech_assets/operational_seed.sql.begin`: Migration contem BEGIN.
- OK - `database/domain-delivery/priority-domains/commerce_fintech_assets/operational_seed.sql.commit`: Migration contem COMMIT.
- OK - `database/domain-delivery/priority-domains/commerce_fintech_assets/operational_seed.sql.no_drop`: Sem DROP TABLE/TYPE destrutivo.
