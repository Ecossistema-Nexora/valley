...
-- Pacote gerado automaticamente para Logistics ERP Operations.
-- Artefato: logistics_erp_operations.priority.v1
...
COMMENT ON VIEW v_logistics_erp_operations_priority_backlog IS
    'Visao operacional do backlog prioritario do dominio logistics_erp_operations.';

COMMENT ON VIEW v_logistics_erp_operations_delivery_artifacts IS
    'Visao dos artefatos fisicos por camada do dominio logistics_erp_operations.';

COMMENT ON VIEW v_logistics_erp_operations_event_contracts IS
    'Visao dos contratos de evento exportados do dominio logistics_erp_operations.';
